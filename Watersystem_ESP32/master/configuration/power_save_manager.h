...
struct PowerSaveManager {
  // printer field removed; not used by BLE-only master
...
static PowerSaveManager g_powerSave = {
  0,    // backlightPin
  0,    // timeoutMs (set later in powerSaveBegin)
  25,   // dimBrightness
  255,  // fullBrightness
  40,   // powerSaveCpuMhz
  240,  // fullCpuMhz
...
void powerSaveBegin(uint8_t backlightPin,
                    uint32_t timeoutMs,
